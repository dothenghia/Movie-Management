...
namespace MovieManagement.Views
{
    ...
    /// </summary>
    public sealed partial class Admin_FilmStars : Page
    {
        public Admin_FilmStars()
        {
            this.InitializeComponent();
            DataContext = new Admin_FilmStars_ViewModel();
        }
        private async void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Dialog_AddNewMovie.Title = "Add New Star";
        ...
        private async void EditButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Dialog_EditMovie.Title = "Edit Star Infomation";
        ...
        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Dialog_DeleteMovie.Title = "Confirm Delete Star";
