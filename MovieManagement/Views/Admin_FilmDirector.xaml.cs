...
namespace MovieManagement.Views
{
    ...
    /// </summary>
    public sealed partial class Admin_FilmDirector : Page
    {
        public Admin_FilmDirector()
        {
            this.InitializeComponent();
            DataContext = new Admin_FilmDirector_ViewModel();
        }
        private async void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Dialog_AddNewMovie.Title = "Add New Director";
            ...
            Dialog_AddNewMovie.Content = new MovieDirectorDialog();
        ...
        private async void EditButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Dialog_EditMovie.Title = "Edit Director Infomation";
            ...
            Dialog_EditMovie.Content = new MovieDirectorDialog();
        ...
        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Dialog_DeleteMovie.Title = "Confirm Delete Director";
