...
namespace MovieManagement.Views
{
    ...
    /// </summary>
    public sealed partial class Admin_FilmContributor : Page
    {
        private Admin_FilmContributor_ViewModel viewModel;
        private DB_MovieManagementContext _context = new DB_MovieManagementContext();
        public Admin_FilmContributor()
        {
            this.InitializeComponent();
            viewModel = new Admin_FilmContributor_ViewModel();
            DataContext = viewModel;
            viewModel.Update_Contributors();
        }
        private async void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            Dialog_AddPerson.Title = "Add New Contribution";
            Dialog_AddPerson.Content = new MovieContributorDialog();
        ...
        //    Dialog_EditPerson.Title = "Edit Contributor";
        //    Dialog_EditPerson.Content = new MovieContributorDialog();
        ...
        private async void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            int roleId = (int)button.DataContext.GetType().GetProperty("RoleId").GetValue(button.DataContext);
            ...
            Dialog_DeletePerson.Title = "Confirm Delete Contributor";
            ...
            {
                var deletecontributor = _context.Contributors.FirstOrDefault(c => c.MovieId == movieId && c.PersonId == personId && c.RoleId == roleId);
                if (deletecontributor != null)
                {
                    _context.Contributors.Remove(deletecontributor);
